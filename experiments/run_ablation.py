#!/usr/bin/env python
"""Component ablations of the full multi-agent system (configs/experiments.yaml: ablations)."""
...
def main() -> None:
    ...
    gr = run_grid(cfg, load_grid("ablations"), "ablation", only=args.only.split(",") if args.only else None)
